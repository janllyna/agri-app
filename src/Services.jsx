...
const Services = () => {
  ...
  return (
    <div className='Servicesbg'>
      ...
      <div className='servicesfeaturesbg'>
        <div className='servicesfeatures'>
          <div className='servicesCard'>
            <img src={require('./feature1.jpg')} className='servicesimg' alt='harvest' />
            <h4 className='featureHead'>Harvesting Products</h4>
            <p>Farming and animal husbandry and discuss
            with farmers and scientists.
            </p>
          </div>
          <div className='servicesCard'>
            <img src={require('./feature2.jpg')} className='servicesimg' alt='harvest' />
            <h4 className='featureHead'>Farming Products</h4>
            <p>Farming and animal husbandry and discuss
            with farmers and scientists.
            </p>
          </div>
          <div className='servicesCard'>
            <img src={require('./feature3.jpg')} className='servicesimg' alt='harvest' />
            <h4 className='featureHead'>Soil Fertilization</h4>
            <p>Farming and animal husbandry and discuss
            with farmers and scientists.
            </p>
          </div>
          <div className='servicesCard'>
            <img src={require('./feature4.jpg')} className='servicesimg' alt='harvest' />
        ...
        <div className='servicesfeatures'>
          <div className='servicesCard'>
            <img src={require('./market.jpg')} className='servicesimg' alt='harvest' />
            <h4 className='featureHead'>Dairy Products</h4>
            <p>Farming and animal husbandry and discuss
            with farmers and scientists.
            </p>
          </div>
          <div className='servicesCard'>
            <img src={require('./services1.jpg')} className='servicesimg' alt='harvest' />
            <h4 className='featureHead'>Product Supplies</h4>
            <p>Farming and animal husbandry and discuss
            with farmers and scientists.
            </p>
          </div>
          <div className='servicesCard'>
            <img src={require('./services2.jpg')} className='servicesimg' alt='harvest' />
            <h4 className='featureHead'>Natural Carrots</h4>
            <p>Farming and animal husbandry and discuss
            with farmers and scientists.
            </p>
          </div>
          <div className='servicesCard'>
            <img src={require('./services3.jpg')} className='servicesimg' alt='harvest' />
            <h4 className='featureHead'>Nutrition Solutions</h4>
            <p>Farming and animal husbandry and discuss
            with farmers and scientists.
            </p>
          </div>
        ...
        <div className='servicesfeatures'>
          <div className='servicesCard'>
            <img src={require('./team3.jpg')} className='servicesimg' alt='harvest' />
            <h4 className='featureHead'>Organic Vegetables</h4>
            <p>Farming and animal husbandry and discuss
            with farmers and scientists.
            </p>
          </div>
          <div className='servicesCard'>
            <img src={require('./team4.jpg')} className='servicesimg' alt='harvest' />
            <h4 className='featureHead'>Fresh Vegetables</h4>
            <p>Farming and animal husbandry and discuss
            with farmers and scientists.
            </p>
          ...
          <div className='servicesCard'>
            <img src={require('./team5.jpeg')} className='servicesimg' alt='harvest' />
          ...
          <div className='servicesCard'>
            <img src={require('./team6.png')} className='servicesimg' alt='harvest' />
